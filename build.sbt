...
organization := "edu.iitd.cse.open_nre.onre_ds" //TODO
...
mainClass in assembly := Some("edu.iitd.cse.open_nre.onre_ds.TestMain") //TODO
...
licenses := Seq("Open IE Software License Agreement" -> url("https://raw.github.com/Open-NRE/ONRE_DS/master/LICENSE"))  //TODO

homepage := Some(url("https://github.com/Open-NRE/ONRE_DS")) //TODO
...
pomExtra := (
  <scm>
    ...
    <connection>scm:git://github.com/Open-NRE/ONRE_DS.git</connection> //TODO
    <developerConnection>scm:git:git@github.com:Open-NRE/ONRE_DS.git</developerConnection> //TODO
    <tag>HEAD</tag>
  </scm>
  <developers>
   <developer>
